...
class TextDetector():
    def __init__(self):
        ...
        self.ort_session = onnxruntime.InferenceSession("/home/raps/altumint_dev/Altumint_Demo_Rahul/src/models/license_plate_recognition/models/ocr_det.onnx",providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
