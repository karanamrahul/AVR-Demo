...
import tools.predict_rec as predict_rec
import tools.predict_det as predict_det
from ocr.utils.utility import get_image_file_list, check_and_read_gif
from tools.ocr_utility import draw_ocr_box_txt
...
class TextSystem(object):
    ...
    def __call__(self, img):
        ...
        if len(dt_boxes) == 0:
            ...
            # self.text_recognizer.convert_to_onnx()
    ...
    for image_file in image_file_list:
        ...
        if is_visualize:
            ...
            draw_img = draw_ocr_box_txt(
                ...
                font_path=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'fonts/simfang.ttf'))
